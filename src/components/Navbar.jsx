    ...
    <nav className="border-b border-gray-300 bg-gray-100 px-5 py-4 sm:px-8">
      <div className="flex max-w-5xl flex-wrap items-center gap-x-5 gap-y-3">
        ...
        <button
          ...
          className={page === 'activity2' ? 'cursor-pointer font-semibold text-red-600' : 'cursor-pointer text-[#222] hover:text-red-600'}
        >
          Activity 2
        </button>
        <button
          ...
          className={page === 'activity3' ? 'cursor-pointer font-semibold text-red-600' : 'cursor-pointer text-[#222] hover:text-red-600'}
        >
          Activity 3
        </button>
        <button
